...
Claude Code는 대화만 하는 게 아닙니다. 실제로 여러 <strong>도구(Tools)</strong>를 사용해서 작업을 수행합니다.
...
Claude Code는 강력한 도구인 만큼, <strong>무엇을 허용할지 직접 제어</strong>할 수 있습니다.
...
CLAUDE.md는 Claude에게 주는 <strong>지시서</strong>라고 생각하면 됩니다.
...
<strong>세션</strong>은 Claude Code를 시작해서 종료하기까지의 하나의 작업 단위입니다.
...
Claude Code가 작업 중에 멈추고 확인을 요청하는 건 <strong>의도된 안전 장치</strong>입니다.
...
> **추천**: 처음에는 <strong>Default 모드</strong>로 시작해서 Claude Code가 무엇을 하는지 파악하고, 익숙해지면 <strong>Auto-Accept 모드</strong>로 전환하세요.
